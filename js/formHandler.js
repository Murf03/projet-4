			...
			submitSuccess: function ($form, event) {
				if (!$form.attr('action')) // Check form doesnt have action attribute
				{
					...
					$.ajax({
						...
						{
							let success_msg = "Your message has been sent.";
							if ($form.is(success_msg)) // Show Success Message
							{
						...
						error: function () // Fail
						{
							let fail_msg = "Sorry it seems that our mail server is not responding, Sorry for the inconvenience!";
